...
export const MINIMAL_DARK_STYLE: StyleSpecification = {
  version: 8,
  name: 'Peak Wireframe',
  sources: {},
  layers: [
...
// Custom layers (terrain, route) are added after style.load fires.
...
export function getBaseStyle(mode: MapStyleMode): string | StyleSpecification {
  switch (mode) {
